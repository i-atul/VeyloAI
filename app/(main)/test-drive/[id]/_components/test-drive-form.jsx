      ...
      <div className="md:col-span-1">
        <Card className="shadow-lg border border-gray-100">
          <CardContent className="p-7">
            <h2 className="text-2xl font-extrabold mb-5 gradient-title">
              Car Overview
            </h2>
            ...
            <div className="mt-5 text-sm text-gray-600 divide-y divide-gray-200">
        ...
        <Card className="mt-7 shadow border border-gray-100">
          <CardContent className="p-7">
      ...
      <div className="md:col-span-2">
        <Card className="shadow-xl border border-gray-100">
          <CardContent className="p-8">
            <h2 className="text-2xl font-extrabold mb-7 gradient-title">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-7">
              ...
              <Button
                type="submit"
                className="w-full py-3 text-lg font-bold bg-gradient-to-r from-[#2af598] to-[#009efd] hover:from-gray-900 hover:to-gray-700 transition rounded-full shadow"
                disabled={bookingInProgress}
              >
                {bookingInProgress ? (
                  <>
                    <Loader2 className="mr-2 h-5 w-5 animate-spin" />
                    Securing Your Test Drive...
                  </>
                ) : (
                  "Reserve Test Drive"
                )}
            ...
            <div className="mt-10 bg-cyan-50 p-5 rounded-xl border border-cyan-100">
              ...
              <ul className="space-y-2 text-base text-gray-700">
                <li className="flex items-start">
                  ...
                  Please bring a valid driver’s license for verification at the dealership.
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                  Enjoy a 30–60 minute drive to fully experience your chosen vehicle.
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                  Our team will be available to answer all your questions and guide you through the process.
                </li>
              </ul>
            </div>
          </CardContent>
      ...
      <Dialog open={showConfirmation} onOpenChange={setShowConfirmation}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Your test drive is booked. Please review your appointment details below:
            </DialogDescription>
          </DialogHeader>
          {bookingDetails && (
            <div className="py-4">
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{dealership?.name || "Veylo Inc."}</span>
                </div>
              </div>
              <div className="mt-4 bg-green-50 p-3 rounded text-sm text-green-700">
                Arrive 10 minutes early and bring your driver’s license for a seamless experience. We look forward to seeing you!
              </div>
            </div>
          )}
          <div className="flex justify-end">
            <Button
              ...
              className="bg-gradient-to-r from-[#2af598] to-[#009efd] text-white font-bold px-6 py-2 rounded-full shadow hover:from-gray-900 hover:to-gray-700 transition"
            >
              Done
            </Button>
          </div>
